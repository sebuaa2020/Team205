#include "../include/team205_robot/addtopics.h"
...
void AddTopics::initUi()
{
    ...
    QTreeWidgetItem* Marker_status=new QTreeWidgetItem(QStringList()<<"Status");
    Marker_status->setIcon(0,QIcon("://images/ok.png"));
    Marker->addChild(Marker_status);
    Marker_status->setHidden(true);
    QTreeWidgetItem* Marker_Topic=new QTreeWidgetItem(QStringList()<<"Topic");
    Marker->addChild(Marker_Topic);
    Marker_Topic->setHidden(true);
    ...
    QTreeWidgetItem* Point_status=new QTreeWidgetItem(QStringList()<<"Status");
    Point_status->setIcon(0,QIcon("://images/ok.png"));
    PointCloud2->addChild(Point_status);
    Point_status->setHidden(true);
    QTreeWidgetItem* Point_Topic=new QTreeWidgetItem(QStringList()<<"Topic");
    PointCloud2->addChild(Point_Topic);
    Point_Topic->setHidden(true);
