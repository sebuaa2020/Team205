#include "../include/team205_robot/settings.h"
    ...
    ui(new Ui::Settings)
{
    ...
    QSettings main_setting("topic_setting","team205_robot");
    ui->lineEdit_odm->setText(main_setting.value("topic_odom","odom").toString());
