/**
 * @file /include/team205_robot/main_window.hpp
 *
 * @brief Qt based gui for team205_robot.
 *
 * @date November 2010
 **/
#ifndef team205_robot_MAIN_WINDOW_H
#define team205_robot_MAIN_WINDOW_H
...
public slots:
	...
	*******************************************/
    ...
    void on_terminal_connect_clicked(bool check );
    void on_terminal_disconnect_clicked(bool check );
    void on_build_map_btn_clicked(bool check );
    void on_save_map_btn_clicked(bool check );
    void on_obj_detect_btn_clicked(bool check );

    void on_add_btn_clicked(bool check );
    void on_send_cmd_clicked(bool check );
    ...
    void quick_cmd_output();
    void quick_cmd_error_output();
    void base_cmd_output();
    void base_cmd_error_output();
    /******************************************
    ** Manual connections
    *******************************************/
    ...
    void slot_add_2D_Point();
    void slot_goto_2D_Point();
    //设置界面
...
#endif // team205_robot_MAIN_WINDOW_H
